define(function () {
  ...
  var seedPlayers = [
    { displayName: 'Alice', state: 'lobby', href: '/api/user/seed:alice' },
    { displayName: 'Bob', state: 'lobby', href: '/api/user/seed:bob' },
    { displayName: 'Charlie', state: 'lobby', href: '/api/user/seed:charlie' }
  ];
