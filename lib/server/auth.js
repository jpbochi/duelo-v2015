  ...
  function middleware(options, isDev) {
    ...
    passport.use(
      ...
      function (request, accessToken, refreshToken, profile, done) {
        console.log(`logging in from google. ${inspect([accessToken, refreshToken, profile])}`);
    ...
    passport.use(
      ...
      function (accessToken, refreshToken, profile, done) {
        console.log(`logging in from facebook. ${inspect([accessToken, refreshToken, profile])}`);
        process.nextTick(function () {
          mongo.users.loginWith(profile, done);
        });
      }
